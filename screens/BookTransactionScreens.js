...
export default class TransactionScreen extends React.Component {
    ...
    handleTransaction = async()=>{
      ...
      if(!transactionType){
        ...
        var isStudentEligibile=await this.checksStudentsEligibilityForIssue()
        if(isStudentEligibile){
          ...
          console.log("here")
          var isStudentEligibile=await checksStudentsEligibilityForReturn()
          if(isStudentEligibile){
    ...
    checksStudentsEligibilityForIssue=async()=>{
    ...
    if(studentRef.docs.length==0){
      ...
      studentRef.docs.map((doc)=>{
        ...
        if(student.numberOfBooksIssued<2){isStudentEligibile=true}
        else{
          isStudentEligibile=false
